...
const quizQuestions = [
  ...
  },
  {
    ...
    answers: [
      { text: "To check a new variable", correct: true },
      { text: "To create a new variable", correct: false },
      { text: "To delete a variable", correct: false },
      { text: "To iterate over an object", correct: false },
    ],
  },
  {
  ...
  {
    question:
      "Which keyword is used to free memory allocated using the new operator?",
    answers: [
